...
declare -r __FIRST_INSTALL_DONE="$__DIR__/../../first_install"
...
function firstInstallNotDone(){
    [ ! -f "${__FIRST_INSTALL_DONE}" ]
    return $?
}
function createEnvFile(){
    ...
    read -p "Enter your database host (default: mysql): " DB_HOST
    DB_HOST=${DB_HOST:-"mysql"}

    read -p "Enter your database name (default: satisfier): " DB_DATABASE
    DB_DATABASE=${DB_DATABASE:-satisfier}

    read -p "Enter your database username (default: root): " DB_USERNAME
    DB_USERNAME=${DB_USERNAME:-root}

    read -p "Enter your database password (default: root): " DB_PASSWORD
    ...
    read -p "Enter your shop URL incl. protocol and path (default: localhost:8090): " SHOP_URL
    SHOP_URL=${SHOP_URL:-http://localhost:8090}
